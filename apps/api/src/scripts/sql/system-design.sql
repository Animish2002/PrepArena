-- PrepArena seed: System Design Theory + MCQ
-- Problems: 18
-- Generated: 2026-07-05T17:05:49.116Z
-- Apply (local):  npx wrangler d1 execute preParena-db --local  --file=src/scripts/sql/system-design.sql
-- Apply (remote): npx wrangler d1 execute preParena-db --remote --file=src/scripts/sql/system-design.sql
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-001', 'SOLID Principles — With Real Examples', 'SOLID Principles', NULL, 'medium', NULL, NULL, 20, 'SOLID Principles', NULL, '["SOLID Principles","system-design"]', 'theory', 'system-design', '
## SOLID Principles
...
```
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-002', 'Design Patterns — Creational', 'Design Patterns', NULL, 'medium', NULL, NULL, 20, 'Design Patterns', NULL, '["Design Patterns","system-design"]', 'theory', 'system-design', '
...
```
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-003', 'Design Patterns — Structural', 'Design Patterns', NULL, 'medium', NULL, NULL, 20, 'Design Patterns', NULL, '["Design Patterns","system-design"]', 'theory', 'system-design', '
...
```
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-004', 'Design Patterns — Behavioral', 'Design Patterns', NULL, 'hard', NULL, NULL, 30, 'Design Patterns', NULL, '["Design Patterns","system-design"]', 'theory', 'system-design', '
...
```
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-005', 'High-Level Design — Scalability Concepts', 'HLD', NULL, 'hard', NULL, NULL, 30, 'HLD', NULL, '["HLD","system-design"]', 'theory', 'system-design', '
...
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-006', 'Designing Scalable APIs — REST, Pagination & Versioning', 'API Design', NULL, 'medium', NULL, NULL, 20, 'API Design', NULL, '["API Design","system-design"]', 'theory', 'system-design', '
...
```
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-007', 'Designing a URL Shortener (System Design Interview)', 'Case Studies', NULL, 'hard', NULL, NULL, 30, 'Case Studies', NULL, '["Case Studies","system-design"]', 'theory', 'system-design', '
...
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-008', 'Designing a Chat System (Real-time Messaging)', 'Case Studies', NULL, 'hard', NULL, NULL, 30, 'Case Studies', NULL, '["Case Studies","system-design"]', 'theory', 'system-design', '
...
```
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-009', 'Microservices — Patterns & Trade-offs', 'Microservices', NULL, 'hard', NULL, NULL, 30, 'Microservices', NULL, '["Microservices","system-design"]', 'theory', 'system-design', '
...
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-theory-010', 'Database Selection — SQL vs NoSQL Decision Framework', 'Databases', NULL, 'hard', NULL, NULL, 30, 'Databases', NULL, '["Databases","system-design"]', 'theory', 'system-design', '
...
', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-001', 'CAP Theorem', 'HLD', NULL, 'hard', NULL, NULL, 5, 'HLD', NULL, '["HLD","system-design","mcq"]', 'mcq', 'system-design', '{"question":"According to CAP theorem, which combination does a traditional relational database (SQL) like PostgreSQL typically prioritize?","options":["AP (Availability + Partition Tolerance)","CA (Consistency + Availability)","CP (Consistency + Partition Tolerance)","All three — CAP theorem doesn''t apply to SQL"],"correct_index":1,"explanation":"Traditional SQL databases (PostgreSQL, MySQL in non-distributed mode) prioritize Consistency and Availability (CA). They sacrifice Partition Tolerance by typically running on a single node or with synchronous replication. In a true network partition, they prefer to fail rather than serve inconsistent data."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-002', 'Horizontal vs Vertical Scaling', 'HLD', NULL, 'easy', NULL, NULL, 5, 'HLD', NULL, '["HLD","system-design","mcq"]', 'mcq', 'system-design', '{"question":"Which type of scaling is preferred for stateless web servers and why?","options":["Vertical — because it doesn''t require code changes","Horizontal — because it can scale indefinitely and provides fault tolerance","Horizontal — because it''s cheaper per unit of performance","Vertical — because it''s simpler to manage"],"correct_index":1,"explanation":"Horizontal scaling (adding more servers) is preferred for stateless web servers because: (1) it has no theoretical upper limit, (2) losing one server doesn''t take down the system, (3) you can scale up/down based on demand. Stateless design is key — each request can be handled by any server."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-003', 'Database sharding key', 'Databases', NULL, 'hard', NULL, NULL, 5, 'Databases', NULL, '["Databases","system-design","mcq"]', 'mcq', 'system-design', '{"question":"You''re sharding a social media database. Which shard key would lead to a \"hot shard\" problem?","options":["user_id (random hash)","created_at (time-based)","Geographic region","Random UUID"],"correct_index":1,"explanation":"Time-based sharding puts all new data in the \"current\" shard, creating a hot shard that receives all writes while older shards sit idle. This is called temporal skew. User_id hash, geographic, and UUIDs distribute load more evenly across shards."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-004', 'WebSocket vs Polling', 'Real-time Systems', NULL, 'medium', NULL, NULL, 5, 'Real-time Systems', NULL, '["Real-time Systems","system-design","mcq"]', 'mcq', 'system-design', '{"question":"For a real-time collaborative document editor (like Google Docs), which communication protocol is most appropriate?","options":["Short polling every 1 second","Long polling","Server-Sent Events (SSE)","WebSocket"],"correct_index":3,"explanation":"WebSocket is bidirectional — both client and server can send data at any time without a new HTTP request. For collaborative editing, clients need to SEND keystrokes and RECEIVE others'' changes simultaneously. SSE is one-way (server → client only). Polling has high latency and server overhead."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-005', 'Cache eviction policies', 'Caching', NULL, 'medium', NULL, NULL, 5, 'Caching', NULL, '["Caching","system-design","mcq"]', 'mcq', 'system-design', '{"question":"For a social media news feed where recent posts are most accessed, which cache eviction policy is most appropriate?","options":["FIFO (First In, First Out)","LFU (Least Frequently Used)","LRU (Least Recently Used)","Random"],"correct_index":2,"explanation":"LRU (Least Recently Used) evicts items that haven''t been accessed recently — perfect for a news feed where recent content gets the most traffic. As posts age, they naturally get evicted when the cache is full. LFU would keep very old viral posts too long; FIFO ignores access patterns entirely."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-006', 'Message queue use case', 'HLD', NULL, 'medium', NULL, NULL, 5, 'HLD', NULL, '["HLD","system-design","mcq"]', 'mcq', 'system-design', '{"question":"An e-commerce system needs to send order confirmation emails. The email service is slow (3 seconds). Which pattern prevents the user from waiting 3 seconds for the checkout response?","options":["Make the email service faster","Use a message queue — checkout service enqueues the task, email service processes asynchronously","Call the email service with a 3-second timeout","Skip sending emails"],"correct_index":1,"explanation":"Message queues decouple the checkout service from the email service. Checkout enqueues an \"order placed\" event (takes <1ms) and immediately responds to the user. The email service independently dequeues and processes messages. This also handles email service failures gracefully — failed messages can be retried."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-007', 'SQL vs NoSQL for analytics', 'Databases', NULL, 'hard', NULL, NULL, 5, 'Databases', NULL, '["Databases","system-design","mcq"]', 'mcq', 'system-design', '{"question":"You''re designing a system that needs to analyze 1 billion user events per day with queries like \"count events by type per hour\". Which is most appropriate?","options":["MySQL with proper indexing","MongoDB for flexible schema","Redis for fast reads","Cassandra or ClickHouse — optimized for time-series write throughput and analytics"],"correct_index":3,"explanation":"For event analytics at scale, you need a database optimized for high-write throughput (events coming in constantly) and efficient aggregation queries. Cassandra handles massive write throughput. ClickHouse is a columnar analytics DB perfect for aggregation queries. MySQL would be overwhelmed by 11,000 writes/second at this scale."}', 'internal');
INSERT OR IGNORE INTO problems (id, title, topic, subtopic, difficulty, platform, platform_link, estimated_minutes, sheet, problem_number, tags, question_type, subject, content, content_source) VALUES ('sd-mcq-008', 'Idempotency key purpose', 'API Design', NULL, 'medium', NULL, NULL, 5, 'API Design', NULL, '["API Design","system-design","mcq"]', 'mcq', 'system-design', '{"question":"A payment API requires clients to send an Idempotency-Key header. What problem does this solve?","options":["Improves response time","Prevents double charges when a request is retried due to network timeout","Authenticates the client","Enables rate limiting per client"],"correct_index":1,"explanation":"Network timeouts leave the client uncertain: did the payment go through? Without idempotency keys, retrying might charge twice. With an idempotency key, the server stores the result mapped to that key. On retry with the same key, it returns the stored result without processing the payment again."}', 'internal');
